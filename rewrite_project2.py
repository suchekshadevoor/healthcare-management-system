...
files = {
    "app.py": textwrap.dedent("""from pathlib import Path
import sqlite3
...
if __name__ == "__main__":
    app.run(debug=True)
"""),
    "init_db.py": textwrap.dedent("""import sqlite3
from pathlib import Path
...
"""),
    ...
    "templates/base.html": textwrap.dedent("""<!DOCTYPE html>
<html lang='en'>
<head>
    <meta charset='UTF-8'>
...
"""),
    "templates/index.html": textwrap.dedent("""{% extends 'base.html' %}
{% block content %}
<section class='hero'>
    <div class='hero-card'>
        <div>
...
{% endblock %}
"""),
    "templates/login.html": textwrap.dedent("""{% extends 'base.html' %}
{% block content %}
...
{% endblock %}
"""),
    "templates/register.html": textwrap.dedent("""{% extends 'base.html' %}
{% block content %}
<section class='auth-page'>
    <div class='auth-card'>
...
{% endblock %}
"""),
    "templates/dashboard.html": textwrap.dedent("""{% extends 'base.html' %}
{% block content %}
...
{% endblock %}
"""),
    "templates/add_hospital.html": textwrap.dedent("""{% extends 'base.html' %}
{% block content %}
...
{% endblock %}
"""),
    "static/js/app.js": textwrap.dedent("""const pageType = document.body.dataset.page;
...
"""),
    "static/css/style.css": textwrap.dedent("""@import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap');
