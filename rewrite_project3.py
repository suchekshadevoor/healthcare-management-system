...
,
    ...
    "templates/base.html": textwrap.dedent('''
        ...
        <body data-page="{{ page_name }}" data-admin="{{ 'true' if current_user and current_user.is_admin else 'false' }}">
...
,
    ...
    ''')
,
    "templates/login.html": textwrap.dedent('''
        {% extends 'base.html' %}
        {% block content %}
    ...
    ''')
,
    "templates/register.html": textwrap.dedent('''
        {% extends 'base.html' %}
        {% block content %}
        <section class="auth-page">
            <div class="auth-card">
    ...
    ''')
,
    "templates/dashboard.html": textwrap.dedent('''
        {% extends 'base.html' %}
        {% block content %}
    ...
    ''')
,
    "templates/add_hospital.html": textwrap.dedent('''
        {% extends 'base.html' %}
        {% block content %}
    ...
    ''')
,
    "static/js/app.js": textwrap.dedent('''
    ...
    ''')
,
    "static/css/style.css": textwrap.dedent('''
